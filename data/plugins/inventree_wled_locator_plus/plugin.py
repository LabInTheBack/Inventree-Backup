...
class WledLocatorPlus(
    ...
    def set_location_indicators(self, location, leds: list[int], controller_label: str | None = None) -> dict:
        return self.locator().set_location_indicators(location, leds, controller_label)
